...
# 数据集配置
DATASET_ID = 'sentiment18'                    # 数据集ID
REGION = 'USA'                           # 区域: 'USA', 'EUR', 'CHN', 'GLB', 'ASI'
UNIVERSE = 'TOP3000'                     # 宇宙: 'TOP3000', 'TOP2500', 'MINVOL1M'等
DELAY = 0                                # 延迟: 0或1
...
# NEUTRALIZATIONS = ["CROWDING","SLOW", "FAST", "REVERSION_AND_MOMENTUM","STATISTICAL"]
INIT_DECAY = 20                           # 初始衰减值
