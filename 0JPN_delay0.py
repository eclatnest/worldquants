...
# 数据集配置
DATASET_ID = 'pv1'                    # 数据集ID
REGION = 'JPN'                           # 区域: 'USA', 'EUR', 'CHN', 'GLB', 'ASI', 'JPN'
UNIVERSE = 'TOP1600'                      # 宇宙: 'TOP500', 'TOP1500' (JPN常用)
DELAY = 0                                # 延迟: 0或1
DATA_TYPE = 'MATRIX'                     # 数据类型: 'MATRIX'或'VECTOR'

# 模拟配置
NEUTRALIZATIONS = ["SUBINDUSTRY", "INDUSTRY", "SECTOR", "MARKET", "NONE"]        # 中性化（数组，可配置多个，会逐个执行）
