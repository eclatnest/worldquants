...
# 数据集配置
DATASET_ID = 'other335'                    # 数据集ID
REGION = 'AMR'                           # 区域: 'USA', 'EUR', 'CHN', 'GLB', 'ASI', 'AMR'
UNIVERSE = 'TOP600'                     # 宇宙: 'TOP3000', 'TOP2500', 'MINVOL1M'等
DELAY = 1                                # 延迟: 0或1
DATA_TYPE = 'MATRIX'                     # 数据类型: 'MATRIX'或'VECTOR'

# 模拟配置
NEUTRALIZATIONS = ["NONE","MARKET","SECTOR","INDUSTRY", "SUBINDUSTRY", "COUNTRY"]        # 中性化（数组，可配置多个，会逐个执行）
